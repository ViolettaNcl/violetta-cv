...
export const metadata: Metadata = {
  title: "Violeta Nikolaou — Junior Full-Stack .NET Developer",
  description: "Portfolio and interactive CV of Violeta Nikolaou, a Junior Full-Stack .NET Developer focused on C#, ASP.NET Core, SQL Server, TypeScript and React.",
