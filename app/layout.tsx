...
export const metadata: Metadata = {
  title: "Виолетта Николау — Junior Full-Stack .NET Developer",
  description: "Portfolio and interactive CV of Виолетта Николау, a Junior Full-Stack .NET Developer focused on C#, ASP.NET Core, SQL Server, TypeScript and React.",
